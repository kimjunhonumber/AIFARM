...
# 질문 1
question1 = "1_ 나는 일상 생활에서 일회용품 사용을 줄이려고 노력한다."
...
# 질문 6
question6 = "6_ 나는 탄소 배출을 줄이기 위해 채식을 고려하거나 실천하고 있다."
...
# 질문 9
question9 = "9_ 나는 에너지 효율이 높은 가전 제품을 사용한다."
...
# 질문 10
question10 = "10_ 나는 탄소 배출을 줄이기 위해 여행을 자제하거나 가까운 곳으로 간다."
...
if st.button("결과 보기"):
    ...
    if analysis:
        ...
        st.download_button(
            ...
            data=txt_file,
            file_name="generated_carbon_footprint_document.txt",
            mime="text/plain"
        )
